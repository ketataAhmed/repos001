<?php /* Smarty version Smarty-3.1.19, created on 2015-04-28 16:19:19
         compiled from "/data/web/prestashop-1-6.evolutive-business.com/admin108gsiemq/themes/default/template/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2048290877553f96e722d3c7-99442852%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '830c31dbc854a20659a39705fdc8158e59af7435' => 
    array (
      0 => '/data/web/prestashop-1-6.evolutive-business.com/admin108gsiemq/themes/default/template/header.tpl',
      1 => 1430129540,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2048290877553f96e722d3c7-99442852',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_553f96e78add90_83374752',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_553f96e78add90_83374752')) {function content_553f96e78add90_83374752($_smarty_tpl) {?>
<!DOCTYPE html>
...
" + "&ajax=1" + "&method=" + $(this).data('method') + ( $(this).data('quicklink-id') ? "&id_quick_access=" + $(this).data('quicklink-id') : ""),
								data: {
									"url": "<?php echo $_smarty_tpl->tpl_vars['link']->value->getQuickLink($_SERVER['REQUEST_URI']);?>
",
									"name": "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['quick_access_current_link_name']->value[0],32);?>
",
